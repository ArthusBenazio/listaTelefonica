...
import com.arthusbenazio.listatelefnica.databinding.ActivityContactDetailBinding
...
class ContactDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonEdit.setOnClickListener {
            ...
            binding.linearLayoutEdit.visibility = View.GONE
            changeEditText(true)
        }

        binding.buttonCancel.setOnClickListener {
            binding.layoutEditDelete.visibility = View.GONE
            binding.linearLayoutEdit.visibility = View.VISIBLE
            populate()
        ...
        launcher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
            if (it.data != null && it.resultCode == 1) {
                ...
                imageId = -1
                binding.imageContact.setImageResource(R.drawable.contacts_icon)
            }
        }
    }
