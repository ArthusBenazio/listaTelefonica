package com.arthusbenazio.listatelefnica.database
...
import com.arthusbenazio.listatelefnica.model.UserModel
...
class DBHelper(context: Context) : SQLiteOpenHelper(context, "database.db", null, 1) {
    ...
    val sql = arrayOf(
        ...
        "INSERT INTO contact (name, address, email, phone, imageID) VALUES ('Maria', 'Address Maria', 'maria@email.com', 991886569, -1)",
        "INSERT INTO contact (name, address, email, phone, imageID) VALUES ('João', 'Address João', 'joao@email.com', 9916878569, -1)",
    )
